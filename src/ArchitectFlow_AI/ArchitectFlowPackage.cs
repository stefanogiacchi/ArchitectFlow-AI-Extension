...
namespace ArchitectFlow_AI
{
    ...
    public sealed class ArchitectFlowPackage : AsyncPackage
    {
            ...
            IProgress<ServiceProgressData> progress)
        {
            try
            {
                ...
                catch (Exception ex)
                {
                    System.Diagnostics.Debug.WriteLine(
                        $"[ArchitectFlow AI] Command registration error: {ex}");
                    ActivityLog.TryLogError("ArchitectFlow AI",
                        $"Command registration failed: {ex}");
                }
            ...
            {
                System.Diagnostics.Debug.WriteLine(
                    $"[ArchitectFlow AI] Package initialization error: {ex}");
                ActivityLog.TryLogError("ArchitectFlow AI",
                    $"Package initialization failed: {ex}");
            }
        }
